              ...
              <div className="flex justify-between mt-8">
                <div className="flex justify-center items-center gap-2">
                  <button className="text-White">
                   <a href="https://github.com/zahidhasan1993/rhythm-retreat-clint">Github</a>  
                  </button><FaArrowRight />
                </div>
          ...
          <div className="bg-none text-white shadow-lg rounded-lg overflow-hidden w-full">
            ...
            <h1 className="font-bold my-2">&#129369; DesiCuisine &#129367;</h1>
              ...
              <div className="flex justify-between mt-8">
                <div className="flex justify-center items-center gap-2">
                  <button className="text-White">
                    <a href="https://github.com/zahidhasan1993/desiCuisine">Github</a> 
                  </button><FaArrowRight />
                </div>
                <div className="flex justify-center items-center gap-2 text-blue-500">
                  <button className="">
          ...
          <div className="bg-none text-white shadow-lg rounded-lg overflow-hidden w-full">
            ...
            <h1 className="font-bold my-2">&#128667; WhizzyWheels &#128663;</h1>
              ...
              <div className="flex justify-between mt-8">
                <div className="flex justify-center items-center gap-2">
                  <button className="text-White">
                    <a href="https://github.com/zahidhasan1993/whizzyWheels">Github</a> 
                  </button><FaArrowRight />
                </div>
                <div className="flex justify-center items-center gap-2 text-blue-500">
                  <button className="">
          ...
          <div className="bg-none text-white shadow-lg rounded-lg overflow-hidden w-full">
            ...
            <h1 className="font-bold my-2">&#128667; AutoMedics &#128668;</h1>
              ...
              <div className="flex justify-between mt-8">
                <div className="flex justify-center items-center gap-2">
                  <button className="text-White">
                    <a href="https://github.com/zahidhasan1993/AutoMedics-clint">Github </a>
                  </button><FaArrowRight />
                </div>
                <div className="flex justify-center items-center gap-2 text-blue-500">
                  <button className="">
