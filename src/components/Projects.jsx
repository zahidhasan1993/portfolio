          ...
          >
            <div className="bg-none text-white shadow-lg rounded-lg overflow-hidden w-full">
              ...
              <div className="p-4">
                ...
                <p className="mb-2">
                  This project is based on a summer camp school.This app is have
                  3 different dashboard for 3 different users.Including a
            ...
            <div className="bg-none text-white shadow-lg rounded-lg overflow-hidden w-full">
              ...
              <div className="p-4 mt-10">
                ...
                <p className="mb-2">
                  ...
                  can add their toys on the app and sell them. They can update
                  or delete a toy and many more...
                </p>
